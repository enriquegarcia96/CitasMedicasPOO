...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        int response = 0;
        do {
            System.out.println("::Book an apponintment");
            ...
            Scanner sc = new Scanner(System.in);
            int reponseDateSelected = Integer.valueOf(sc.nextLine());

            Map<Integer, Doctor> doctorAvailableSelected = doctors.get(reponseDateSelected);
            Integer indexDate = 0;
            Doctor doctorSelected = new Doctor("", "");

            for ( Map.Entry<Integer, Doctor> doc : doctorAvailableSelected.entrySet() ) {
                //obtengo los datos confirmados
            ...
            System.out.println("Confirm your apoointment: \n1. Yes \n2. change Data");
